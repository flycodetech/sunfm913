...
if ( ! function_exists( 'verse_tribe_events_get_css' ) ) {
	add_filter( 'verse_filter_get_css', 'verse_tribe_events_get_css', 10, 2 );
	function verse_tribe_events_get_css( $css, $args ) {
...
.tribe-common .tribe-common-b3.tribe-events-calendar-month-mobile-events__mobile-event-cost,
