...
if ( ! function_exists( 'verse_woocommerce_get_css' ) ) {
	add_filter( 'verse_filter_get_css', 'verse_woocommerce_get_css', 10, 2 );
	function verse_woocommerce_get_css( $css, $args ) {
...
$fdir = verse_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
