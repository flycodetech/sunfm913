...
WordPress version: required at least 5.0, tested up to 6.1.1
...
Please install and activate it before starting to use the theme Verse.
...
Theme documentation is available on https://verse.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Verse is Fontello.
